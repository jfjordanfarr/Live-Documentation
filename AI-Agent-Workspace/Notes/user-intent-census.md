...
Tracking the explicit guidance provided by `jfjordanfarr` across Dev Days 1–72. Each entry references the source chat log and line range so future agents can reconstruct the full context during autosummarization windows.
