...
#### Stream LD1-A – Authored Framework _(in progress)_
...
#### Stream LD1-B – Mirror Tree & Migration _(planned)_
...
#### Stream LD1-C – Safety & Governance _(planned)_
...
#### Stream LD2-A – Symbol & Docstring Extraction _(in motion)_
...
#### Stream LD2-B – Dependency Resolution _(in progress)_
...
#### Stream LD2-C – Evidence & Coverage _(planned)_
...
#### Stream LD2-D – Polyglot Oracles _(in progress)_
...
#### Stream LD3-C – Enforcement & Linting _(planned)_
...
#### Stream LV1-E – Non-Headless Inspect (Local Map From/To) _(complete)_

- [x] Add `From` and `To` inputs to the Local Map view so maintainers can run `live-docs inspect`-equivalent pathfinding without leaving the explorer. _(Shipped 2025-12-18, commit `a0cc5de2`.)_
...
#### Stream LDG-C – Generative Scaffolding _(stretch goal)_
...
#### Stream LD4-A – Packaging & Licensing _(in progress)_
...
#### Stream LD4-B – External Integrations _(planned)_
...
#### Stream LD8-A – Public Site Pipeline _(planned)_
...
#### Stream LD8-B – Requirement Handoff _(planned)_
...
#### Stream LD8-C – Materialized View CLI _(complete — MVP)_

- [x] Ship `npm run live-docs:system` that streams System analytics (markdown/JSON) to stdout or a caller-provided temp directory without committing artefacts. _(Shipped 2026-01-17 with `--output`, `--clean`, `--dry-run`, and `--config` options.)_
- [x] Remove the committed `.live-documentation/system/` mirror once the CLI is validated; update lint/safe-commit rules to block stray System files. _(System layer is now ephemeral-only.)_
- [ ] Author integration tests and fixture workspaces that prove messy repos surface debt via the CLI output alone. _(Planned for future polish.)_
...
#### Stream H1-A – Stateless Runner _(planned)_
...
#### Stream H1-B – Bundle Assembly & Guidance _(planned)_
...
- Include prompt guides and CLI recipes tailored for AI-assistant workflows so hosted trials showcase downstream consumption without promising cloud-only execution.
...
#### Stream H1-C – Consent, Privacy & Telemetry _(planned)_
...
#### Stream B1-A – Read-Only Respect _(planned)_
...
#### Stream B1-B – Link-Driven Discovery _(planned)_
...
#### Stream B1-C – Layer Mapping & Indexing _(planned)_
...
### IMP-901 docstringRoundTripService _(wishlist)_
...
### IMP-902 liveDocsAuthoringCommands _(wishlist)_
