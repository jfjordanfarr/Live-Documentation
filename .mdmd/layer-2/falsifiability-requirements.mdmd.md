...
- ~~Dependency Quick Pick consumes Live Doc metadata to satisfy REQ-F4.~~ _(Descoped 2026-02-18: dependency exploration now served by `live-docs:inspect` CLI and Explorer Local Map.)_
