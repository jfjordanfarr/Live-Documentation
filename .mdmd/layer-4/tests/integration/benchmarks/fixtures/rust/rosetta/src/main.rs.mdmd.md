# tests/integration/benchmarks/fixtures/rust/rosetta/src/main.rs
...
## Authored
### Purpose
Entry point for the Rust Rosetta Stone fixture. Demonstrates mod declarations and use statements.
