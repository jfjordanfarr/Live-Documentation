...
- Returns: [`PublishCodeDiagnosticsResult`](#symbol-publishcodediagnosticsresult)
- Parameters: `options`: [`PublishCodeDiagnosticsOptions`](#symbol-publishcodediagnosticsoptions)
