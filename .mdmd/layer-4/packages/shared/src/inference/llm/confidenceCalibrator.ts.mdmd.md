...
- Returns: [`CalibratedRelationship`](#symbol-calibratedrelationship)[]
- Parameters: `candidates`: [`RawRelationshipCandidate`](./relationshipExtractor.ts.mdmd.md#symbol-rawrelationshipcandidate)[]; `context`: [`CalibrationContext`](#symbol-calibrationcontext)
