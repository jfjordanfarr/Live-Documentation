...
- When the focused directory contains both files and subdirectories (mixed content), files are excluded from squarified layout and assigned zero-area rects (added [Dev Day 83](../../../../../../../../../../AI-Agent-Workspace/ChatHistory/2026/03/2026-03-27.1.md)). The browse renderer handles files separately via a card-grid zone, solving the area-crushing problem where files at weight=1 were dwarfed by directories at weight=N.
